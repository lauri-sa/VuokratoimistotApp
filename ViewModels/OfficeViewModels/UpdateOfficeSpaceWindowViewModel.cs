...
{
    /// <summary>
    /// Datacontext class for UpdateOfficeSpaceWindow. Inherits MainViewModel class.
    /// </summary>
    internal class UpdateOfficeSpaceWindowViewModel : MainViewModel
    {
        ...
        /// <summary>
        /// Validates the inputs for updating a office space and sets error messages for any invalid input fields.
        /// </summary>
        ...
        /// <summary>
        /// Updates a office space to the database via the OfficeSpaceRepository class and closes the current window if successful.
        ...
        /// </summary>
        public void UpdateOfficeSpaceToDatabase()
        {
            try
            {
                OfficeSpaceRepository.UpdateOfficeSpace(OfficeSpaceModel);
            ...
            catch (Exception ex)
            {
                ...
                ErrorWindowViewModel.RetryMethod = () => UpdateOfficeSpaceToDatabase();
        ...
        ///  office space is updated to the database by calling the UpdateOfficeSpaceToDatabase() method.
        /// </summary>
        private void AddButton()
        {
            if (InputValidation())
            {
                UpdateOfficeSpaceToDatabase();
            }
        }
