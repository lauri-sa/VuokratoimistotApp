...
{
    /// <summary>
    /// Datacontext class for UpdateOfficeWindow. Inherits MainViewModel class.
    /// </summary>
    internal class UpdateOfficeWindowViewModel : MainViewModel
    {
        private static OfficeModel _officeModel;
        public static OfficeModel OfficeModel { get { return _officeModel; } set { _officeModel = value; OnStaticPropertyChanged(); } }
        ...
        /// <summary>
        /// Validates the inputs for updating a office and sets error messages for any invalid input fields.
        /// </summary>
        ...
        /// <summary>
        /// Updates a office to the database via the OfficeRepository class and closes the current window if successful.
        ...
        /// </summary>
        public void UpdateOfficeToDatabase()
        {
            try
            {
                OfficeRepository.UpdateOffice(OfficeModel);
            ...
            catch (Exception ex)
            {
                ...
                ErrorWindowViewModel.RetryMethod = () => UpdateOfficeToDatabase();
        ...
        /// office is updated to the database by calling the UpdateOfficeToDatabase() method.
        /// </summary>
        private void AddButton()
        {
            if (InputValidation())
            {
                UpdateOfficeToDatabase();
            }
        }
